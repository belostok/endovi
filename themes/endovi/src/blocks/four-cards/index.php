...
namespace endoviTheme\Blocks\FourCards;
...
function register_fields() {
	...
	acf_add_local_field_group(
		array(
			'key'                   => 'group_6a885f97d6cba',
			'title'                 => esc_attr__( 'Блок Четыре карточки', 'endovi' ),
			'fields'                => array(
				array(
					'key'               => 'field_6a885f9947700',
					'label'             => esc_attr__( 'Скрыть', 'endovi' ),
					'name'              => 'four_cards_hide',
					'aria-label'        => '',
					'type'              => 'true_false',
					'instructions'      => '',
					'required'          => 0,
				...
				array(
					'key'               => 'field_6a8860a647706',
					'label'             => esc_attr__( 'Изображение бэкграунда', 'endovi' ),
					'name'              => 'four_cards_image_mobile',
					'aria-label'        => '',
					'type'              => 'image',
				...
				array(
					'key'               => 'field_6a88600147701',
					'label'             => esc_attr__( 'Заголовок', 'endovi' ),
					'name'              => 'four_cards_title',
					'aria-label'        => '',
					'type'              => 'textarea',
					'instructions'      => '',
					'required'          => 0,
				...
				array(
					'key'                   => 'field_6a88602c47702',
					'label'                 => esc_attr__( 'Цвет заголовка', 'endovi' ),
					'name'                  => 'four_cards_title_color',
					'aria-label'            => '',
					'type'                  => 'color_picker',
					'instructions'          => '',
					'required'              => 0,
				...
				array(
					'key'               => 'field_6a88604947703',
					'label'             => esc_attr__( 'Карточки', 'endovi' ),
					'name'              => 'four_cards_items',
					'aria-label'        => '',
					'type'              => 'repeater',
					'instructions'      => '',
					'required'          => 0,
					...
					'sub_fields'        => array(
						array(
							...
							'placeholder'       => '',
							'new_lines'         => 'br',
							'parent_repeater'   => 'field_6a88604947703',
						),
					),
				),
			),
