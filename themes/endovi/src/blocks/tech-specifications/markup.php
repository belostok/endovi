...
>
	<div class="endovi-tech-specifications__wrapper endovi-wrapper relative">
		...
		<?php endif; ?>
		<div class="endovi-tech-specifications__content flex fdc relative"
			style="--tech-spec-models: <?php echo (int) $models_count; ?>;">
			<div class="endovi-tech-specifications__title-container relative">
				<?php if ( $_title ) : ?>
			...
			<div class="endovi-tech-specifications__table-container">
				<div class="endovi-tech-specifications__table-inner">
