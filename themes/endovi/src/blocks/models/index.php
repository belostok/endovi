	...
	acf_add_local_field_group(
		array(
			...
			'fields'                => array(
				...
				array(
					'key'               => 'field_6a67a1794fkj8',
					'label'             => esc_attr__( 'Тип', 'endovi' ),
					'name'              => 'models_v2',
					'aria-label'        => '',
					'type'              => 'true_false',
					'instructions'      => '',
					...
					'default_value'     => 0,
					'allow_in_bindings' => 0,
					'ui_on_text'        => esc_attr__( 'Модели', 'endovi' ),
					'ui_off_text'       => esc_attr__( 'Ряд', 'endovi' ),
					'ui'                => 1,
				),
				array(
