...
namespace endoviTheme\Blocks\Mission;
...
function register_fields() {
	...
	acf_add_local_field_group(
		array(
			'key'                   => 'group_69cfce50a3e2b',
			'title'                 => esc_attr__( 'Mission block', 'endovi' ),
			'fields'                => array(
				array(
					'key'               => 'field_69cfce51dc9f9',
				...
				array(
					'key'               => 'field_69cfce89dc9fa',
					'label'             => esc_attr__( 'Предзаголовок', 'endovi' ),
					'name'              => 'mission_pre_title',
					'aria-label'        => '',
					'type'              => 'text',
					'instructions'      => '',
					'required'          => 0,
				...
				array(
					...
					'sub_fields'        => array(
						array(
							...
							'allow_in_bindings' => 0,
							'preview_size'      => 'medium',
							'parent_repeater'   => 'field_69cfced9d3263',
						),
						array(
							'key'               => 'field_69cfcf1cd3265',
							'label'             => esc_attr__( 'Заголовок', 'endovi' ),
							'name'              => 'title',
							'aria-label'        => '',
							'type'              => 'textarea',
